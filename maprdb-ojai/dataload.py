...
# input json file for sensors
DATA_SENSORS_PATH = "/home/verdyr/maprdb_python/ws.json"

# input json file for maintenance
DATA_MAINT_PATH = "/home/verdyr/maprdb_python/maint.json"

# path in HDFS/MapR-FS where the table will live
TABLE_SENSORS_PATH = "/user/verdyr/sdata"
TABLE_MAINT_PATH = "/user/verdyr/mdata"
